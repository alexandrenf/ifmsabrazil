...
2. [Diferença entre a Primeira Etapa e as Vagas Remanescentes](#diferenca-entre-a-primeira-etapa-e-as-vagas-remanescentes)
...
### Primeira Etapa
É a primeira oferta de vagas de cada PIN, a concorrência é maior, e a classificação do estudante é feita por meio de critérios de pontuação, dentro desses critérios temos: participação em monitoria, liga acadêmica, projeto de extensão, iniciação científica, atividades vinculadas à IFMSA Brazil, dentre outros.
...
Para se inscrever no PIN, o estudante deve estar matriculado em uma faculdade que tenha um comitê pleno vinculado à IFMSA Brazil e seguir alguns passos básicos:

1. **Acesso à plataforma exchange:** Primeiro, é necessário se cadastrar no sistema da IFMSA Brazil, caso ainda não tenha um perfil (se você já participou de alguma atividade vinculada à IFMSA Brazil ou ao comitê local da sua faculdade, você provavelmente tem um cadastro e, para ter acesso a ele, entre em contato com os diretores locais do comitê local da sua cidade).
...
3. **Espera pela Divulgação:** Após isso, é só esperar a divulgação da lista de classificados.

4. **Classificação:** Caso você seja classificado, basta assinar o Instrumento Particular de Vaga Bilateral, pagar as taxas referentes à sua vaga e anexar esses documentos na plataforma e no forms que disponibilizamos mensalmente junto à lista de classificados.

## Tipos de Hospedagem

Os tipos de hospedagem disponíveis para os intercambistas variam entre:

- **Bilateral:** O intercambista é recebido na casa de alguém e deve receber um intercambista na sua casa da mesma forma. Além disso, ele recebe duas refeições por dia e deve oferecê-las ao intercambista que irá receber também.
...
- **Unilateral:** O intercambista é recebido na casa de alguém e não precisa receber um intercambista na sua casa. Além disso, ele recebe duas refeições por dia.
...
Na primeira etapa, nós só disponibilizamos hospedagens bilaterais. No entanto, nas vagas remanescentes, os quatro tipos de hospedagem estão disponíveis.

Vagas unilaterais precisam passar por uma deliberação. Portanto, o intercambista, no momento da inscrição, deve escrever no campo destinado para tal o porquê precisa dessa vaga unilateral ou unilateral e própria, já que um princípio muito importante da IFMSA Brazil é a bilateralidade.
...
- **Taxa I:** R$130,00
- **Taxa II:** R$300,00
- **Taxa III:** R$450,00 (somente para vagas unilaterais)

Os inscritos em vagas bilaterais ou bilaterais e próprias devem pagar as taxas I e II, enquanto os inscritos em vagas unilaterais ou unilaterais e próprias devem pagar as taxas I, II e III.

## Edital de Vulnerabilidade

O edital de vulnerabilidade faz parte da Política de Inclusão do Coordenador Local em Vulnerabilidade Socioeconômica que a IFMSA Brazil possui no seu Regimento Geral. A finalidade é realizar a concessão gratuita de pelo menos duas inscrições, financiamento de passagens aéreas e/ou terrestres, isenção das taxas e bolsa auxílio, conforme Regimento, aos estudantes de graduação em vulnerabilidade socioeconômica filiados a um comitê local pleno da IFMSA Brazil, interessados em participar do Período de Intercâmbio Nacional que será aberto. Sendo que apenas é válido para a primeira etapa do PIN, onde todas as vagas são bilaterais.
...
- Enviar um e-mail para: [none.in@ifmsabrazil.org](mailto:none.in@ifmsabrazil.org), [none.ex@ifmsabrazil.org](mailto:none.ex@ifmsabrazil.org) ou [tin.scone@ifmsabrazil.org](mailto:tin.scone@ifmsabrazil.org)
